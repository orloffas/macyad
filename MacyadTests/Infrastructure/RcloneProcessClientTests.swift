...
final class RcloneProcessClientTests: XCTestCase {
    ...
    func testOperationInspectorFindsMatchingCopyInPgrepOutput() async throws {
        ...
        try """
        #!/bin/sh
        printf '4863 rclone copy macyad-yandex:/RemoteDesktopManagerFree /Users/zerotool/Documents/YaD/RemoteDesktopManagerFree --config /tmp/rclone.conf\n'
        ...
        let operation = raw
            ...
            .compactMap { line -> ActiveRcloneCopyOperation? in
                ...
                guard commandLine.contains("rclone"),
                      ...
                      commandLine.contains("/Users/zerotool/Documents/YaD/RemoteDesktopManagerFree"),
