...
У Яндекс Диска нет macOS-клиента, которому спокойно доверяешь большую папку. `rclone` эту работу делает отлично, но это CLI: флаги пишешь сам, и одно неверное направление молча затирает годовой архив.
