...
О случаях домогательства, а так же оскорбительного или иного другого неприемлемого поведения можно сообщить мейнтейнеру, [@orloffas](https://github.com/orloffas), через [приватный отчёт о безопасности](https://github.com/orloffas/macyad/security/advisories/new) — это единственный приватный канал в этом репозитории. Все жалобы будут рассмотрены и расследованы оперативно и беспристрастно.
