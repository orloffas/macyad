...
- Проблемы импорта (нет папки, не настроен remote) не блокируют импорт: пара приезжает выключенной и с пометкой в итоговом alert, чтобы её можно было починить на месте.
