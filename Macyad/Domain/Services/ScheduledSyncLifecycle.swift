...
public struct ScheduledSyncLifecycle: Sendable {
    /// Called immediately before `SyncService.push(...)` or
    /// `SyncService.pull(...)` is invoked for a scheduled run. Return a
    /// non-nil observer to receive every rclone log line; return nil to skip
    /// live observation for this run.
